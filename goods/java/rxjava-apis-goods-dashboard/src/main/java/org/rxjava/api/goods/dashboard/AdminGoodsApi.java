...
public class AdminGoodsApi {
	...
	private static final ApiType _0Type = ApiUtils.type(Goods.class);
	private static final ApiType _1Type = ApiUtils.type(Page.class, ApiUtils.type(Goods.class));
}